...
<h1 className='md:text-2xl text-center'><span className='font-semibold'>Mint Price</span><br/>.042069 ETH</h1>
<h1 className='md:text-2xl text-center'><span className='font-semibold'>Total Supply</span><br/>15,000</h1>
